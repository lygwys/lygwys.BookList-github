...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new CloudBookListCfg());
        }
...
<text name="CloudBookList" value=""></text><text name="QueryCloudBookList"  value="查询"></text><text name="CreateCloudBookList"  value="添加"></text><text name="EditCloudBookList"  value="编辑"></text><text name="DeleteCloudBookList"  value="删除"></text><text name="BatchDeleteCloudBookList" value="批量删除"></text><text name="ExportCloudBookList"  value="导出"></text>                             
