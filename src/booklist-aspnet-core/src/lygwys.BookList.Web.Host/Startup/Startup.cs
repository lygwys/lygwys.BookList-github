...
using lygwys.BookList.Authentication.JwtBearer;
using lygwys.BookList.Configuration;
using lygwys.BookList.Identity;

using Abp.AspNetCore.SignalR.Hubs;

namespace lygwys.BookList.Web.Host.Startup
{
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("lygwys.BookList.Web.Host.wwwroot.swagger.ui.index.html");
            }); // URL: /swagger
        }
    }
}
